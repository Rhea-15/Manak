...
def check_requirement_status(requirement, today=None):
    ...
    if not requirement.is_active:
        return {
            "status": "inactive",
            "reason": "Requirement is inactive"
        }
    ...
    if requirement.effective_to and today > requirement.effective_to:
        return {
            "status": "expired",
            "reason": "Requirement has expired"
        }
    ...
    return {
        ...
        "reason": "Requirement is active and verified"
    }
...
def check_compliance_rules(
    ...
    for requirement_type, model in REQUIREMENT_MODELS.items():
        ...
        for requirement in requirements:
            ...
            result = check_requirement_status(
                requirement,
                today
            )
